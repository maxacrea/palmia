	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
			...
			<tr class="shipping">
				...
				<td data-title="<?php esc_attr_e( 'Shipping', 'woocommerce' ); ?>" class="text-right"><?php woocommerce_shipping_calculator(); ?></td>
			</tr>
		...
		<tr class="order-total">
			...
			<td data-title="<?php esc_attr_e( 'Total', 'woocommerce' ); ?>" class="text-right text-xl"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
